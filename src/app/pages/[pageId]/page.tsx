...
const validPageIds = ['vnls2', 'vnshblackbogo1', 'vnshcamobogo1', 'vnsmp1', 'vnls1', 'vns3mmbonus', 'vnshlite1', 'vnsmm1', 'vnshggg1', 'vnls1po223', 'vnshblackbogogbb1', 'vnshggg1fs', 'vnshblackbogogbb2', 'vnshblackbogogbb3', 'vnsmmfs1', 'vnls1fh2', 'vnshswtbogo1'] as const;
