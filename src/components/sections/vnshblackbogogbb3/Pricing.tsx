      ...
      const plansData = [
        {
          ...
          features: [],
          image: starterImage,
          ctaLink: buildUrlWithParams('https://secure.vnsh.com/vnshblackbogogbb3/starter-checkout'),
          ctaText: 'Add to Cart',
          isPopular: false,
        ...
        },
        {
          ...
          description: '',
          shipping: '+ Free S&H',
          features: ['<b>+ 4 Colors</b> (Black, Gray, Camo, Nude)'],
          image: eliteImage,
          ctaLink: buildUrlWithParams('https://secure.vnsh.com/vnshblackbogogbb3/advanced-checkout'),
          ctaText: 'Add to Cart',
          isPopular: true,
        ...
        },
        {
          ...
          features: ['<b>+ 4 Colors</b> (Black, Gray, Camo, Nude)'],
          image: ultimateImage,
          ctaLink: buildUrlWithParams('https://secure.vnsh.com/vnshblackbogogbb3/enhanced-checkout'),
          ctaText: 'Add to Cart',
          isPopular: false,
