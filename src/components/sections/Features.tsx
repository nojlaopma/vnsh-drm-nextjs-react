    ...
    <section className="pt-2 pb-6">
      <div className="max-w-[1100px] mx-auto px-4" style={{ fontFamily: 'Arial, sans-serif' }}>
        <div className="text-left mb-12">
          <p className="text-[22px] text-black mb-4 ">Aside from your new VNSH Holster… what you're about to see on this page is by far the <b className='italic'>#1 thing you can get to maximize your defensive capabilities.</b></p>
          
          <p className="text-[22px] text-black mb-4 ">You already have a gun…</p>
          
          <p className="text-[22px] text-black mb-4 ">And you just got an ultra-comfy holster to start carrying everywhere…</p>
          
          <p className="text-[22px] text-black mb-4 ">The <b className="italic">only thing you're missing</b> is…</p>
          
          <p className="text-[22px] text-black mb-4 ">…a way to guarantee you can deploy your weapon with <b className='italic'>dead-eye accuracy</b> in a <b className='italic'>split-second</b> conflict scenario (which nearly all conflict scenarios are).</p>
          
          <p className="text-[22px] text-black mb-4 ">That's why we're giving you a <b>private, one-time deal</b> on a breakthrough product that does exactly that.</p>
          
          <p className="text-[22px] text-black mb-4 "><span className="font-bold">It's our revolutionary Laser Strike Training System</span> – <b className='bg-yellow-300'>normally $149.97, but only $79.97 for you today only!</b></p>
          
          <p className="text-[22px] text-black mb-4 ">And the reason why 1000s of gun owners swear by it is because…</p>
          
          <p className="text-[22px] text-black mb-4 ">It simulates <b className='italic'>unlimited live fire trigger pulls</b> so you can get in the training volume it takes to reach your full accuracy potential – without spending a <b className='italic'>small fortune in ammo</b> plus hours and hours at the range.</p>
          
          <p className="text-[22px] text-black mb-4 ">It's without a doubt the <b className='italic'>fastest and easiest way to become dead accurate</b> (and also the only way we know of that's <u>money-back guaranteed</u>).</p>
          ...
          <h2 className="text-[38px] font-bold text-center  my-0 mx-5">
            ...
            <span className="block text-red-600 text-[38px] mt-2 ">
        ...
        <div className="mb-12">
          ...
          <p className="text-[22px] text-black mb-8 ">
          ...
          <div className="space-y-8">
            {features.map((feature, index) => (
              <div key={index} className="relative pl-12">
                ...
                <span className="text-[22px] text-black ">{feature.description}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="space-y-6 mb-8">
            <p className="text-[22px] text-[#212529]">You carry for one simple reason: <span className="font-bold">to make sure you get home safe no matter what.</span></p>
            <p className="text-[22px] text-[#212529]">And if someone tries to stop that from happening, you'll likely have <span className="font-bold">a few seconds</span> and possibly <span className="font-bold">just 1 shot</span> to react.</p>
            <p className="text-[22px] text-[#212529]">The Laser Strike System gives you the confidence to <span className="font-bold underline">ensure you NEVER miss that shot!!</span></p>
            <p className="text-[22px] text-[#212529]">Like we said...</p>
            <p className="text-[22px] text-[#212529]">Because we already know <b className="italic">you're the kind of person</b> who cares deeply about <u>being the most effective protector possible</u> (for both yourself and those around you)...</p>
            <p className="text-[22px] text-[#212529]">And since we <b className="italic">have no doubt you'll be amazed</b> at how rapidly the Laser Strike System will <span className="font-bold underline">skyrocket your accuracy...</span></p>
            <p className="text-[22px] font-bold bg-[#ff0] inline-block">
              On this page only, we're giving you one for $70 OFF!
            </p>
            <p className="text-[22px] text-[#212529]">But you won't see this deal again after you leave this page...</p>
            <p className="text-[22px] text-[#212529]">So grab yours NOW!</p>
          </div>
        </div>
      </div>
    </section>
