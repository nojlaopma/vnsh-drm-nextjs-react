...
const BogoFeatures = () => {
  ...
  const utmParams = Array.from(searchParams.entries())
    ...
    .join('&');
  const checkoutUrl = `https://secure.vnsh.com/vnls1po223/checkout${utmParams ? `?${utmParams}` : ''}`;
      ...
      <p 
        ...
        <div className="text-left text-[18px] md:text-[22px] text-black">
          ...
          >
            ...
            <span className='text-[#dc3545] underline'>  Kill Their Bad Shooting Habits</span>
