      ...
      const plansData = [
        {
          ...
          features: [],
          image: starterImage,
          ctaLink: buildUrlWithParams('https://secure.vnsh.com/vnshblackbogogbb2/starter-checkout'),
          ctaText: 'Add to Cart',
          isPopular: false,
        ...
        },
        {
          ...
          image: eliteImage,
          ctaLink: buildUrlWithParams('https://secure.vnsh.com/vnshblackbogogbb2/advanced-checkout'),
          ctaText: 'Add to Cart',
          isPopular: true,
        ...
        },
        {
          ...
          features: ['<b>+ 4 Colors</b> (Black, Gray, Camo, Nude)'],
          image: ultimateImage,
          ctaLink: buildUrlWithParams('https://secure.vnsh.com/vnshblackbogogbb2/enhanced-checkout'),
          ctaText: 'Add to Cart',
          isPopular: false,
