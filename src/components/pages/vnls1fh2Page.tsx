...
// Import BogoHero and BogoFeatures from the vnls1fh2 sections
import { BogoHero, BogoFeatures } from '@/components/sections/vnls1fh2';

interface vnls1fh2po223PageProps {
  params: {
    pageId: string;
  };
...
export default function vnls1fh2po223Page({ params }: vnls1fh2po223PageProps) {
  useEffect(() => {
