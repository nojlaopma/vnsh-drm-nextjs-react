...
// Import BogoHero and BogoFeatures from the vnshggg1fs sections
import { BogoHero, BogoFeatures } from '@/components/sections/vnshggg1fs';
...
export default function Vnsmp1Page({ params }: Vnsmp1PageProps) {
  useEffect(() => {
   ...
   if (header) {
     ...
     link.innerHTML = 'Complimentary Hardcopies for the Next 288 Americans!'; 
