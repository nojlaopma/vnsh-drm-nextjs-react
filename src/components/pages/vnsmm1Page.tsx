...
// Import BogoHero and BogoFeatures from the vnsmm1 sections
import { BogoHero, BogoFeatures } from '@/components/sections/vnsmm1';
...
export default function VnshBlackBogo1Page({ params }: VnshBlackBogo1PageProps) {
  ...
  return (
    <div className="w-full bg-[#fff] px-[20px] md:px-[75px] max-w-[1140px] mx-auto relative overflow-hidden min-h-screen flex flex-col font-arial">
      <main>
        <BogoHero />
        <BogoFeatures />
      </main>
